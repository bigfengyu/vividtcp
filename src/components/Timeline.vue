...
<div class="timeline" id="timeline">
  <div class="timeline-wrap">
    <mu-row class="timeline-scroll">
      ...
      <mu-col desktop="50" tablet="70" width="70" class="timeline-center">
        <Transcanvas :time-animate-scale="timeScale" :sec-inter-scale="secInterScale" :prevent-order-set="preventOrderSet" :now-time="nowTime" v-on:begindrawline="tagLine" v-on:enddrawline="tagLine"></Transcanvas>
      </mu-col>
...
export default {
  ...
  methods: {
    ...
    hTimelineStyle() {
      return {
        top: this.scaleY(this.nowTime * this.timeScale * this.secInterScale + 5) - 15 + 'px'
      };
    },
    addline(line) {
